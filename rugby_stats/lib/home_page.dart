            ...
            Visibility(
              ...
              child: Padding(
                ...
                child: FilterPanel(
                  ...
                  onApply: () { /* Lógica de filtrado aquí */ },
                  onClear: () => setState(() {
        ...
        OutlinedButton(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(_isFilterExpanded ? ' CERRAR FILTROS ' : ' CONSULTAR MÁS PARTIDOS '),
              Icon(_isFilterExpanded ? Icons.arrow_drop_up : Icons.arrow_drop_down),
            ],
          ),
        ),
        const SizedBox(height: 12),
